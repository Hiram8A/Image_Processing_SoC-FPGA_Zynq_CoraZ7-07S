...
/* Se Especifica la Resolucion de la Imagen*/
#define inputImageWidth 512
#define inputImageHeight 512

/* Se Especifica el Escalamiento a aplicar en la Imagen*/
/* Usar 1 para NO aplicar Escalamiento*/
#define scale 2
...
int main(){
	...
	if(status != XST_SUCCESS){
		print("Error de inicialización DMA\n");
		return -1;
	}
	...
	xil_printf("Enviar imagen y después pulse la tecla enter\n\r");
	...
	print("Transferencia DMA exitosa..\n\r");
	/*for(int i=0;i<12;i++)
		xil_printf("%0x\n\r",outputImage[i]);*/
	return 0;
}
